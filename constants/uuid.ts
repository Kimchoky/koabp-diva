...
// KoaBP service UUID
export const UUID_SERVICE_CUSTOM_TOTAL_ = '6e400001-b5a3-f393-e0a9-e50e24dcca9e';
export const UUID_SERVICE_CUSTOM_TOTAL = '6e400001b5a3f393e0a9e50e24dcca9e';
// KoaBP (write) characteristic UUID: 데이터 송신
export const UUID_CHARACTERISTIC_CUSTOM_TOTAL_WRITE_ = '6e400002-b5a3-f393-e0a9-e50e24dcca9e';
...
export const UUID_CHARACTERISTIC_CUSTOM_TOTAL_NOTIFY_DATA_ = '6e400003-b5a3-f393-e0a9-e50e24dcca9e';
