...
export const UUID_CHARACTERISTIC_CUSTOM_TOTAL_WRITE = '6e400002-b5a3-f393-e0a9-e50e24dcca9e';
// KoaBP (notifiable) characteristic UUID: 데이터 수신
export const UUID_CHARACTERISTIC_CUSTOM_TOTAL_NOTIFY_DATA = '6e400003-b5a3-f393-e0a9-e50e24dcca9e';
